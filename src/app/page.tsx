      ...
      <section className="bg-[oklch(0.985_0.005_85)] px-6 py-12">
        <div className="mx-auto max-w-lg text-center">
          ...
          <div className="mt-6 flex flex-col gap-3">
            ...
            <Link
              href="/sentinel?deviceId=demo&secret=demo&name=Demo&lang=en"
              className="group relative flex items-center gap-4 overflow-hidden rounded-xl border border-orange-200 bg-white py-3.5 pl-5 pr-4 text-left text-base font-medium text-orange-600 transition-all hover:bg-orange-50 hover:border-orange-300"
            >
              {/* Eye/skeleton icon */}
              ...
              <span className="flex-1"><span className="font-bold">Pose Detection Preview</span><br /><span className="text-xs text-orange-400">Test your camera — see AI skeleton tracking live</span></span>
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="transition-transform group-hover:translate-x-1 shrink-0">
                <path d="M5 12h14M12 5l7 7-7 7" />
              </svg>
            </Link>
